...
--
-- Servidor: localhost
-- Tiempo de generación: 20-09-2023 a las 00:07:16
...
(15, 'Gabi', 'barron', 12356, 'asd@dsad.asd', 'Neurosi');
...
INSERT INTO `pacientes` (`id_paciente`, `nombre`, `apellido`, `edad`, `fecha`, `sintomas`, `historial_medico`, `historial_penal`, `id_enfermero`, `id_area`) VALUES
(1, 'Gabi', 'Baronni', 19, '20-20-2003', 'dolor de cabez', '3 veces resfriado la semana pasada', 'en cana una semana', 1, 1);
...
--
ALTER TABLE `areas`
  MODIFY `id_area` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `enfermeros`
--
ALTER TABLE `enfermeros`
  MODIFY `id_enfermero` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `pacientes`
  MODIFY `id_paciente` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
